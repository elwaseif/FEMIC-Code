...
function [p_final, muh_final, rms_error2, G,sense]=FEMIC_tost21(MM,S,el,pobs,sigma,muv,err_tol,max_iter,q,sx,sz,wta,pmin,pmax,coords)

%% Initialize array size and constant parameters
MM.con(MM.con>0)=log10(MM.con(MM.con>0));
...
%for i=1:max_iter,       % loop over iterations (A1)
  ...
  [Gx, Gz]=newgradient(dx,dz);als=.0011;%V=0;
   Gs = sx*Gx+sz*Gz;

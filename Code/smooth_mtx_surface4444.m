function mesh=smooth_mtx_surface4444(input,mesh,W,mm,nn,sx,sz)
%WW12=w12;
%WW13=w13+w23+w14+w12;
%Wt12 = spdiags((WW12), 0, mm*nn, mm*nn); 
Wt13 = spdiags((W), 0, mm*nn, mm*nn); 
 %Wt14 = spdiags((w14), 0, mm*nn, mm*nn); 
 %Wt23 = spdiags((w23), 0, mm*nn, mm*nn);
...
mesh.ctc=sx*cx'*(Wt13'*Wt13)*cx+sz*cy'*(Wt13'*Wt13)*cy;%ctc1+ctc2;        

function [prd, varargout] = fdem1dfwd2(aq,S,M,el,flg)
...
%  Geophysical Journal International, 187(1), 21, doi:10.1111/j.1365-246X.2011.05165.x.
...
yy = find(strcmp(S.tor,'y') & strcmp(S.ror,'y')); %VCP
xx = find(strcmp(S.tor,'x') & strcmp(S.ror,'x')); %VCX
